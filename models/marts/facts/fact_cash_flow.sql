with device_transactions as (
    select 
        ...
        'device_sale' as source_type -- update to use seed based on business logic
...
song_transactions as (
    select 
        ...
        'song_played' as source_type -- update to use seed based on business logic
...
stock_costs as (
    select
        ...
        'stock_purchased' as source_type -- update to use seed based on business logic
